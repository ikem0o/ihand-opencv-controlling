...
ppModes, ppModesFolder = [], "interfaceImages/ppModes"
for modePath in os.listdir(ppModesFolder):
    ppModes.append(cv2.imread(os.path.join(ppModesFolder, modePath)))
...
# Create a window.
root = tkinter.Tk()
root.title('[iKEMOO] iHand - Power Point Control v2')
    ...
    if lmList:
        ...
        if activeMode:
            ...
            if fingers == [1, 1, 0, 0, 0]:
                ...
                workOnceTimer = True
            # If first finger are up click page down button in keyboard for once.
            if fingers == [1, 0, 0, 0, 0] and clickMode:
                mainBackground[248:248+117, 691:691+115] = ppModes[1]
                keyboard.press_and_release('page down')
                clickMode = False
                workOnceTimer = True
            # If sec. finger are up click page up button in keyboard for once.
            if fingers == [0, 1, 0, 0, 0] and clickMode:
                mainBackground[248:248+117, 691:691+115] = ppModes[2]
